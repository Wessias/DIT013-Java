...
import static ex6moreoomodels.catchtherain.Bucket.BUCKET_HEIGHT;
import static ex6moreoomodels.catchtherain.Bucket.BUCKET_SPEED;
import static ex6moreoomodels.catchtherain.CatchTheRain.GAME_HEIGHT;
import static ex6moreoomodels.catchtherain.CatchTheRain.GAME_WIDTH;
import static ex6moreoomodels.catchtherain.Ground.GROUND_HEIGHT;

/*
     This an objected oriented GUI application example.
     A game for catching raindrops in a bucket.
     - Using a OO-model
     - Using JavaFX for to display model

     This is the GUI. To run the game run this
     (no logic here)
 */
public class CatchTheRainGUI extends Application {
    ...
    @Override
    public void init() {
        // Create the OO model (RainDrops crated later, come and go)
        List<Positionable> drops = new ArrayList<>();
