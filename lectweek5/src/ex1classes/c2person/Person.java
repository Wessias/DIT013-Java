...
public class Person {
    ...
    public Person(String name) {
        this(name, 0, 0);
        // Person(name, 0 , 0);    // Can't do like below (must be used in conjunction with new)
        // Would create another object !? Not what we want, we would like to initialize this object
    }
    ...
    // Here equals by name, in real life better use some unique id.
    @Override
